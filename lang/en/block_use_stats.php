...
$string['configkeepalivedelay_desc'] = 'Delay between two keepalive log traces for connected users. Keep as big as possible to lower server load when many users are connected, while keeping tracking tracks consistant.';
