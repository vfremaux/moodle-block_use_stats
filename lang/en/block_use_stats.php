...
$string['configignoremodules'] = 'Ignore modules';
$string['configignoremodules_desc'] = 'Modules to be ignored in all tracking measurements.';
$string['configcapturemodules'] = 'Capture modules';
$string['configcapturemodules_desc'] = 'Modules to be ignored in all tracking measurements, but hose time will be captured and added to overal course time.';
