...
$string['configlastpingcredit'] = 'Ce temps (en minutes) sera ajouté au calcul à chaque fois qu\'une fin ou une discontinuité de session est supposée';
...
$string['configlastcompiled'] = 'On change of this track date, the cron will recalculate all logs following the given date';$string['dimensionitem'] = 'Classes observables';
$string['errornorecords'] = 'Aucune donnée de tracking';
$string['errornotinitialized'] = 'Ce module ne semble pas avoir été initialisé. Contactez l\'adminsitrateur.';
$string['eventscount'] = 'Nombre de hits';
$string['from'] = 'Depuis ';
$string['fromwhen'] = 'Depuis ';
