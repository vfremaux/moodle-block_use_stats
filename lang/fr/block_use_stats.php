...
$string['configkeepaliveenable'] = 'Activer le maintien de session';
$string['configkeepaliveenable_desc'] = 'Le maintien de session provoque une émission régulière de requêtes de maintien de session tant que l\'utilisateur affiche une page moodle à l\'écran. Notez que cette méthode doit être utilisée avec précaution, car elle peut mesurer des comportements locaux non pertinents.';
...
$string['configignoremodules'] = 'Modules à ignorer';
$string['configignoremodules_desc'] = 'Les temps de ces modules seront ignorés.';
$string['configcapturemodules'] = 'Modules à capturer';
$string['configcapturemodules_desc'] = 'Les temps de ces modules seront ignorés, mais comptabilisés de manière transparente dans les temps du cours.';
