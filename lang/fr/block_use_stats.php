...
$string['configkeepalivedelay_desc'] = 'Délai entre deux envois de message de maintien de session (minutes). Régler ce paramètre sur la plus grande valeur possible qui maintienne la cohérence de votre tracking.';
