...
class test_client {
    ...
    public function test_get_users_course_stats($uidsource = '', $uids = array(), $cidsource = '', $cid = 0, $from = 0, $to = 0, $score = true) {
        ...
        $params = array('wstoken' => $this->t->wstoken,
                        'wsfunction' => 'block_use_stats_get_users_course_stats',
                        'moodlewsrestformat' => 'json',
                        'uidsource' => $uidsource,
                        'uids' => $uids,
                        'cidsource' => $cidsource,
...
/*
$client->test_get_users_stats('id', array(3,4,5), 'id', 2); // Test one course some users.
$client->test_get_users_stats('idnumber', array('ADMIN','ID_A1','ID_A2'), 'id', 2); // Test one course some users by idnumber.
*/

$client->test_get_users_course_stats('id', array(3,4,5), 'id', 2); // Test one course some users.
$client->test_get_users_course_stats('idnumber', array('ADMIN','ID_A1','ID_A2'), 'id', 2); // Test one course some users by idnumber.
