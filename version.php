...
$plugin->version   = 2012031802;        // The current plugin version (Date: YYYYMMDDXX)
...
$plugin->release = '2.2.0 (build 2012031802)'; // Full name of the plugin (used for diagnostics)
